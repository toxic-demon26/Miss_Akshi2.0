...
from Miss_Akshi.modules import ALL_MODULES
from Miss_Akshi.modules.helper_funsc.chat_status import is_user_admin
from Miss_Akshi.modules.helper_funsc.misc import paginate_modules
...
buttons = [
        ...
        InlineKeyboardButton(
            text="𝘈𝘥𝘥 𝘮𝘦 𝘯𝘰𝘸➕", url="t.me/Miss_Akshi_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="𝘔𝘪𝘴𝘴 𝘈𝘬𝘴𝘩𝘪 𝘭𝘰𝘨𝘴❤",url=f"https://t.me/Miss_Akshi_logs"),
    ],
    [
        InlineKeyboardButton(
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Miss_Akshi.modules." + module_name)
